...
class Transaction(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("transaction_currency ~ '^[A-Z]{3}$' AND fx_rate > 0", name='currency'),
    ...
    @property
    def transaction_currency_locked(self):
        return self.instrument.asset_type in ('STOCK', 'ETF')
